...
@scenario(create_items)
def test_get_list_failed_authentication_without_key(context):
...
@scenario(create_items)
def test_get_list_failed_authentication_with_wrong_key(context):
    APIKey.objects.all().delete()
...
@scenario(create_items)
def test_get_list_successful_authentication(context):
    # Delete all items
...
@scenario(create_items)
def test_get_list_filter_by_user(context):
    # Delete all items
    UserItem.objects.all().delete()
    APIKey.objects.all().delete()
    User.objects.all().delete()
